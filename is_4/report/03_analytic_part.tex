...
\FloatBarrier
\imgw{1\textwidth}{img/exmple_1}{Пример работы алгоритма шифрования и расшифровки с открытым ключом архивного файла}
\FloatBarrier
...
\FloatBarrier
\imgw{1\textwidth}{img/exmple_2}{Пример работы алгоритма шифрования и расшифровки с открытым ключом файла при попытке попытки открытия зашифрованного архива}
\FloatBarrier
